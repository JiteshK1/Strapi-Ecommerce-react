            ...
            <div className="container px-5 md:py-24 mx-auto">
                <div className="flex flex-wrap w-full md:mb-20">
                    <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Products List - My Shop </h1>
...
export async function getServerSideProps(context) {
    let headers = { Authorization: "Bearer " }
    let a = await fetch('http://localhost:1337/api/products?populate=*', { headers: headers })
    let products = await a.json()

    return {
        props: { products: products },//we can write only products
    }
}
